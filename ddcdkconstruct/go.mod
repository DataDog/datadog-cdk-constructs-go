module github.com/DataDog/datadog-cdk-constructs-go/ddcdkconstruct/v4
...
require (
	...
	github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v53 v53.22.0 // indirect
)
