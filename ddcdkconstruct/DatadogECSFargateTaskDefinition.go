...
func (j *jsiiProxy_DatadogECSFargateTaskDefinition) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_DatadogECSFargateTaskDefinition) TaskDefinitionRef() *interfacesawsecs.TaskDefinitionReference {
...
func (d *jsiiProxy_DatadogECSFargateTaskDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
